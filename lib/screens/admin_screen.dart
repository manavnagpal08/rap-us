...
class _AdminScreenState extends State<AdminScreen> {
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text('Global system configuration and metrics', style: GoogleFonts.inter(fontSize: 12, color: const Color(0xFF64748B))),
            ],
          ),
          SizedBox(
            height: 48,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(name, style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: selected ? Colors.white : AppTheme.primary)),
            ],
          ),
        ),
      ),
  ...
  Widget _buildKeyInput(String label, TextEditingController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: GoogleFonts.inter(fontWeight: FontWeight.w700, fontSize: 13, color: AppTheme.primary)),
