...
class _VerificationCenterScreenState extends State<VerificationCenterScreen> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [color.withValues(alpha: 0.1), Theme.of(context).cardColor],
        ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Complete verifications to boost your score and get 3x more leads.',
  ...
  Widget _buildCredentialItem({
    ...
    String status =
        _verificationStatus?['${key}_status'] ??
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (isVerified ? AppTheme.success : AppTheme.primary)
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isVerified
                      ? 'Verified'
                      : (status == 'submitted' ? 'Under Review' : subtitle),
                  style: GoogleFonts.inter(
                    fontSize: 12,
                    color: isVerified
                        ? AppTheme.success
    ...
    return Opacity(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: earned ? const Color(0xFFFFD700) : Colors.transparent,
          ),
        ),
        child: Column(
          children: [
  ...
  Future<void> _uploadDoc(String key) async {
    ...
    if (result != null) {
      ...
      String fileName =
          'verification/${_auth.currentUser!.uid}/$key.${file.path.split('.').last}';
