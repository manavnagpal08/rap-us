  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        stream: _db.getUserChats(user.uid),
        builder: (context, snapshot) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final otherId = members.firstWhere((id) => id != user.uid, orElse: () => '');
              
              return FutureBuilder<Map<String, dynamic>?>(
                future: _db.getUserProfile(otherId),
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            ...
                            child: Text(name[0].toUpperCase(), style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.primary)),
                          ),
