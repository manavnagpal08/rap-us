...
class _MyHomeInventoryScreenState extends State<MyHomeInventoryScreen> {
  ...
  // Filtered estimates by room serve as the inventory source
              ...
              builder: (context, snapshot) {
                ...
                return GridView.builder(
                  ...
                  gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
                    ...
                    childAspectRatio:
                        0.85, // Taller but smaller width generally due to count
                    crossAxisSpacing: 16,
                    mainAxisSpacing: 16,
                  ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.inter(
                        fontSize: 9,
                        color: item['repair_or_build'] == 'Build'
                            ? AppTheme.success
                            : AppTheme.accent,
        ...
        children: [
          ...
          Text(
            _selectedRoom == 'All'
                ...
                : 'No items recorded for this room.',
