...
class PdfService {
  Future<void> generateAndPrintEstimate(Map<String, dynamic> data, String? base64Image, String currencySymbol) async {
    ...
    if (base64Image != null && base64Image.isNotEmpty) {
      try {
        ...
        debugPrint('Error decoding pdf image: $e');
      }
    }
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              _costRow('Standard Labor', '$currencySymbol${data['labor_cost_original_usd']}'),
              _costRow('Labor Discount (20%)', '-$currencySymbol${(double.parse(data['labor_cost_original_usd'].toString()) * 0.2).toStringAsFixed(2)}'),
              _costRow('Final Labor Cost', '$currencySymbol${data['labor_cost_final_usd']}', isBold: true),
              pw.Divider(),
              _costRow('Material Cost', '$currencySymbol${data['material_cost_total_usd']}'),
              pw.SizedBox(height: 10),
              pw.Container(
                ...
                child: pw.Column(
                  children: [
                    _costRow('Total Likely Estimate', '$currencySymbol${data['total_estimate_range_usd']['likely']}', isBold: true),
                    pw.Text('Range: $currencySymbol${data['total_estimate_range_usd']['low']} - $currencySymbol${data['total_estimate_range_usd']['high']}', style: const pw.TextStyle(fontSize: 10)),
                  ],
                ),
              ),
              pw.Spacer(),
